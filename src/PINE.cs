// Shamelessly lifted from https://github.com/isJuhn/KAMI
using System;
...
namespace RatchetTurretServer
{
    public static class PINE
    {
        ...
        public static ulong Read8(IntPtr v, uint address, bool batch = false)
        {
            return pine_read(v, address, IPCCommand.MsgRead8, batch);
        }

        public static ulong Read16(IntPtr v, uint address, bool batch = false)
        {
            return pine_read(v, address, IPCCommand.MsgRead16, batch);
        }

        public static UInt32 Read32(IntPtr v, uint address, bool batch = false)
        {
            return (UInt32) pine_read(v, address, IPCCommand.MsgRead32, batch);
        }
        ...
        public static void Write8(IntPtr v, uint address, Byte val, bool batch = false)
        {
            pine_write(v, address, val, IPCCommand.MsgWrite8, batch);
        }
        
        public static void Write16(IntPtr v, uint address, UInt16 val, bool batch = false)
        {
            pine_write(v, address, val, IPCCommand.MsgWrite16, batch);
        }

        public static void Write32(IntPtr v, uint address, UInt32 val, bool batch = false)
        {
            pine_write(v, address, val, IPCCommand.MsgWrite32, batch);
        }

        public static void Write64(IntPtr v, uint address, UInt64 val, bool batch = false)
        {
            pine_write(v, address, val, IPCCommand.MsgWrite64, batch);
        }
